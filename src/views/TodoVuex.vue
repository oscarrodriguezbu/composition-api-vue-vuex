<template>
  ...
  <h4>Pendientes: {{ pending.length }}</h4> <!-- forma optimizada para acceder al store -->

  <hr>
  <!-- 'active': currentTab === 'all' es una condicion para que se muestre activo -->
  <!-- el click cambia el current tab de una vez -->
  ...
  <!-- Modal --> <!-- componente con m minuscula porque se quiere colocar cosas dentro -->
