<template>
  <div class="modal-background fade-in" @click.self="$emit('on:close')"> <!-- .self se ejecuta si o solo si, se hace click a ese elemento y no a sus hijos -->
...
export default {
  props: ['title'],
  emits: ['on:close'], //buena practica para hacer saber de este emit a otro desarrollador, no funciona en vue 2
  setup(props, context) {
