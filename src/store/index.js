...
export default createStore({
  ...
  getters: {
    pendingTodos( state, getters, rootState ) { //rootState se refiere a un state global
    ...
    getTodosByTab: ( _ , getters ) => ( tab ) => { // _ cuando el primer argumento viene pero no se necesita, en este caso era state
      //( _ , getters ) => ( tab ) => { es una funcion que regresa otra funcion
      switch ( tab ) {
